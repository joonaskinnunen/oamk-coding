...
// Ohjelma on tehty ja testattu MBED Studio 1.3.1 -versiolla 7.12.2020 / J.Kaski.
// Vanhaan ohjelmaversioon verrattuna oli tullut aika paljon muutoksia.
...
// Arduinon Serial Plotterilla, niin laita ensin MBED Studion sarjayhteys-ikkuna kiinni
// ja vapauta portti toista ohjelmaa varten.
//
// Anturin datasheet luettu 7.12.2020:
// http://pdf1.alldatasheet.com/datasheet-pdf/view/435303/STMICROELECTRONICS/L3G4200D.html
// Huomaa, että datasheetissä dps = degree /second, joka on siis kulmanopeuden yksikkö.
//
...
// Ratkaisin ongelman siten, että otin vanhemmalla versiolla asennetun kirjastokansion
// tämän projektin ohjelmakansioon: "L3G4200D". Kansio oli luotu Nucleo F3030RE -alustalle.
// joten se toimii vain sillä. Latasin kansion pakattuna Dropboxiin: L3G4200D.7z,
// josta voi sitä tarvittaessa kokeilla kopioimalla sen purettuna samaan paikkaan,
// kuin missä main.cpp sijaitsee.
...
timer.reset();
	...
	//	timer.reset(); // Nollataan kello seuraavaa kierrosta varten
        ...
        // itse laitteeseen!
        // Huom! Varsinkin kulman tulostusvaiheessa on hyvä seurailla asentoa nopeasti 
        // ja tulostaa asennon päivitys tietyllä "tulostusvälillä".
